...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Stripe Billing Developer",
    "Supabase Developer",
    "Chrome Extension SaaS Developer",
  ...
  "@graph": [
    {
      ...
      jobTitle: "Chrome Extension Developer & Full-Stack SaaS Engineer | Manifest V3, Browser Automation & AI Copilots",
    ...
    },
    {
      ...
      "@id": `${DATA.url}/#website`,
      url: DATA.url,
      name: `${DATA.name} - Chrome Extension & Full-Stack SaaS Developer`,
      description: DATA.seoDescription,
      publisher: {
        "@id": `${DATA.url}/#person`,
      },
      ...
      potentialAction: {
        "@type": "SearchAction",
        target: `${DATA.url}/projects?q={search_term_string}`,
