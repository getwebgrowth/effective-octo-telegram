...
export const alt = "Projects & Case Studies | Pasindu Piumal";
export const size = {
    width: 1200,
    height: 630,
};
...
export default async function Image() {
    try {
        ...
        const description = "113+ Custom Chrome Extensions (Manifest V3), AI Copilots, and Browser Automation Systems.";
                        ...
                        <div style={styles.wrapper}>
                            {imageUrl && (
                                <div style={styles.imageSection}>
                                    <img src={imageUrl} alt="Pasindu Piumal" style={styles.image} />
                                </div>
                            )}
