  ...
  "@graph": [
    {
      ...
      mainEntity: {
        ...
        jobTitle: "Chrome Extension Developer & Full-Stack SaaS Engineer",
        url: DATA.url,
        sameAs: [
...
export default function ContactPage() {
    return (
        <main className="relative min-h-screen py-12 pb-24 sm:py-20 px-6">
                ...
                <div className="space-y-8">
                    ...
                    <BlurFade delay={BLUR_FADE_DELAY * 2.5}>
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            ...
                            {/* WhatsApp */}
                            <a
                                href="https://wa.me/94717123826?text=Hi%20Pasindu%2C%20I%20found%20your%20portfolio%20and%20would%20like%20to%20discuss%20a%20project"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex flex-col gap-1 p-3.5 rounded-xl border border-[#25D366]/30 bg-[#25D366]/5 hover:bg-[#25D366]/10 hover:border-[#25D366]/60 backdrop-blur-xs transition-all group relative overflow-hidden"
                            >
                                <div className="flex items-center justify-between mb-1">
                                    <div className="size-8 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-md shadow-[#25D366]/25 group-hover:scale-105 transition-transform">
                                        <svg viewBox="0 0 24 24" className="size-4.5 fill-white" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span className="inline-flex items-center gap-1 text-[9px] font-bold text-[#25D366] uppercase tracking-wider bg-[#25D366]/10 px-1.5 py-0.5 rounded-full">
                                        <span className="size-1.5 rounded-full bg-[#25D366] animate-pulse"></span>
                                        Instant
                                    </span>
                                </div>
                                <p className="text-[10px] font-semibold text-[#25D366] uppercase tracking-wide">WhatsApp</p>
                                <p className="font-bold text-xs text-foreground tracking-tight">{DATA.contact.tel}</p>
                                <p className="text-[10px] text-muted-foreground mt-0.5 group-hover:text-[#25D366] transition-colors font-medium">Click to chat directly →</p>
                            </a>
            ...
            {/* Floating WhatsApp Quick Action Button (Only on Contact Page) */}
            <aside aria-label="WhatsApp Quick Contact" className="fixed bottom-20 right-4 sm:bottom-8 sm:right-8 z-40">
                <a
                    href="https://wa.me/94717123826?text=Hi%20Pasindu%2C%20I%20found%20your%20portfolio%20and%20would%20like%20to%20discuss%20a%20project"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Direct WhatsApp Chat with Pasindu Piumal"
                    className="group relative flex items-center gap-2 p-3 sm:px-4 sm:py-2.5 rounded-full bg-[#25D366] text-white shadow-xl shadow-[#25D366]/35 hover:shadow-2xl hover:shadow-[#25D366]/50 hover:scale-105 active:scale-95 transition-all duration-200 border border-white/25"
                >
                    <span className="relative flex size-2.5">
                        <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-white opacity-80"></span>
                        <span className="relative inline-flex rounded-full size-2.5 bg-white"></span>
                    </span>
                    <svg viewBox="0 0 24 24" className="size-5 sm:size-4.5 fill-white shrink-0" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                    </svg>
                    <span className="text-xs font-bold tracking-tight pr-0.5 hidden sm:inline">Chat on WhatsApp</span>
                </a>
            </aside>
        </main>
    );
