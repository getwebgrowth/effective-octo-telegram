    ...
    },
    {
      ...
      itemListElement: DATA.projects.slice(0, 6).map((project, index) => ({
        ...
        item: {
          ...
          ...(project.href ? { url: `${DATA.url}${project.href}` } : {}),
        },
      })),
    },
  ],
  ...
  return (
    <main className="min-h-dvh relative">
      ...
      <div className="max-w-2xl mx-auto py-12 pb-24 sm:py-24 px-6 space-y-14">
            ...
            <BlurFade delay={BLUR_FADE_DELAY * 10}>
              <div className="flex flex-wrap gap-2">
                {DATA.skills.map((skill) => (
                  <div key={skill.name} className="border bg-background border-border ring-2 ring-border/20 rounded-xl h-8 w-fit px-4 flex items-center gap-2 hover:border-primary/40 transition-colors">
                    {skill.icon && (
                      <skill.icon
        ...
        <section id="hackathons" aria-label="Open Source & Hackathons">
