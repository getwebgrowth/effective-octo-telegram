...
image: "/projects/onelearning-feature-overview.png"
---
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
  <div className="rounded-2xl overflow-hidden border border-border/80 bg-muted/20 shadow-lg flex flex-col">
    <img
      src="/projects/onelearning-linkedin-browser.png"
      alt="OneLearning — Live LinkedIn Saved Posts Chrome Side Panel Interface"
      className="w-full h-auto object-cover"
    />
    <div className="p-3 bg-card/60 border-t border-border/60 text-xs text-muted-foreground mt-auto">
      <strong>Active Chrome Side Panel:</strong> OneLearning docked alongside linkedin.com/my-items/saved-posts/ with 1-click post import.
    </div>
  </div>
  <div className="rounded-2xl overflow-hidden border border-border/80 bg-muted/20 shadow-lg flex flex-col">
    <img
      src="/projects/onelearning-feature-overview.png"
      alt="OneLearning — Tag Taxonomy, Multi-Select Categories & Manage Tags Canvas"
      className="w-full h-auto object-cover"
    />
    <div className="p-3 bg-card/60 border-t border-border/60 text-xs text-muted-foreground mt-auto">
      <strong>Feature Architecture:</strong> Color-coded tag taxonomy (Startup, Marketing, Finance, etc.), custom notes, and modal tag manager.
    </div>
  </div>
</div>
