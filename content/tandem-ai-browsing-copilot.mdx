...
<FaqCard question="What is the pricing to build a custom AI browser copilot?" answer="Custom AI extensions are typically delivered in 48-72 hours, available starting at $35/hr tracked via Upwork or fixed milestone escrow." />
