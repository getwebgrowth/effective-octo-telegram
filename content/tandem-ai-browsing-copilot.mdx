...
image: "/projects/tandem-ai-browsing-copilot.png"
---
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
  <div className="rounded-2xl overflow-hidden border border-border/80 bg-muted/20 shadow-lg flex flex-col">
    <img
      src="/projects/tandem-ai-browsing-copilot-browser.png"
      alt="Tandem AI — Chrome Side Panel Interface in Google Chrome"
      className="w-full h-auto object-cover"
    />
    <div className="p-3 bg-card/60 border-t border-border/60 text-xs text-muted-foreground mt-auto">
      <strong>Active Chrome Side Panel:</strong> Direct natural language AI querying across historical browsing sessions and active tabs.
    </div>
  </div>
  <div className="rounded-2xl overflow-hidden border border-border/80 bg-muted/20 shadow-lg flex flex-col">
    <img
      src="/projects/tandem-ai-browsing-copilot-overview.png"
      alt="Tandem AI Extension — AI History Copilot Feature Overview"
      className="w-full h-auto object-cover"
    />
    <div className="p-3 bg-card/60 border-t border-border/60 text-xs text-muted-foreground mt-auto">
      <strong>Feature Architecture:</strong> Autonomous AI agent securely accessing and synthesizing indexed browser history.
    </div>
  </div>
</div>
